...
{    
   ...
   JHTP( "Java How to Program", "2010","No1" ),                        
   ...
   // instance fields 
   private final String copyrightYear; // book title
   private final String title; // copyright year
   private final String number;
   // enum constructor
   Book( String bookTitle, String year, String no ) 
   { 
      title = bookTitle;
      copyrightYear = year;
      number = no;

		...
		if (productChoice != 0)
		{
			...
			if (productPrice.compareTo(new BigDecimal("0")) != 0)
			{
				...
				if (productNum != 0)
				{
					...
					int ifEnterInfo=ioPak.getInt(CS.LEVEL3,"Your choice:", 1,2);
					if(ifEnterInfo==1)
					{
					...
					{
						ioPak.printf(CS.LEVEL3,"\nSale confirmation:\n");
						ioPak.printTable(30,CS.LEVEL3, "!!", "ID of the employee:!!%d\n"
								+ "Product ID:!!%d\n"
